...
def get_options(args=None):
    ...
    parser.add_argument('--train_dataset',type=str, default=None, help='Dataset file to use for train')
    parser.add_argument('--shuffle',type=int, default=0, help='whether shuffle train dataset')
