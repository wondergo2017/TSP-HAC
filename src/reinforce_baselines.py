...
import copy
from .train import rollout, get_inner_model,eval_loss
import numpy as np
...
class WarmupBaseline(Baseline):
    ...
    def epoch_callback(self, model, epoch,dataset=None):
        ...
        self.baseline.epoch_callback(model, epoch,dataset)
...
class RolloutBaseline(Baseline):
    ...
    def __init__(self, model, problem, opts, epoch=0,dataset=None,tb_logger=None):
        super(Baseline, self).__init__()
